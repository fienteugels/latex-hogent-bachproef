...
\section{\IfLanguageName{dutch}{Verantwoord gebruik van AI bij de ontwikkeling}{Responsible Use of AI in Development}}

Bij de ontwikkeling van de proof-of-concept werd gebruikgemaakt van Claude Code (Anthropic) als AI-ondersteunde coding-assistent. Het gebruik hiervan was ondersteunend van aard: Claude Code stelde codefragmenten en implementatiepatronen voor, maar alle gegenereerde code werd door de ontwikkelaar zelf beoordeeld, aangepast en getest. De uiteindelijke architectuurkeuzes, componentstructuur en integratie met Application Insights werden zelfstandig bepaald en zijn niet het resultaat van automatisch gegenereerde output.

Bij het gebruik van AI-tools werd rekening gehouden met een aantal principes voor verantwoord gebruik:

\begin{itemize}
  \item \textbf{Geen persoonsgegevens als input:} Er werden nooit deelnemersgegevens of ruwe onderzoeksdata ingegeven in AI-tools. Enkel anonieme, technische codevragen werden gesteld.
  \item \textbf{Kritische verificatie:} Alle AI-suggesties werden gecontroleerd op correctheid, veiligheid en overeenstemming met de vereisten van het onderzoek. Foutieve of ongeschikte voorstellen werden manueel gecorrigeerd of verworpen.
  \item \textbf{Transparantie:} Het gebruik van AI-assistentie wordt hier expliciet vermeld, zodat de lezer een correct beeld heeft van het ontwikkelingsproces.
  \item \textbf{Eigenaarschap:} De ontwikkelaar behoudt volledige verantwoordelijkheid voor de correctheid en kwaliteit van de code. AI-tools werden ingezet als productiviteitshulpmiddel, niet als vervanger van technisch inzicht.
\end{itemize}

Dit gebruik sluit aan bij de richtlijnen van HOGENT rond academische integriteit en het verantwoord inzetten van AI-hulpmiddelen bij bachelorproeven.
